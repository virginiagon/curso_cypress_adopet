...
- `Teste de API`: Teste de API que faz uma requisão GET com um token de autorização e verifica as mensagens enviadas pelos usuários do Adopet.
...
- `Lista Pets`: Teste de login com credenciais válidas e inválidas.
